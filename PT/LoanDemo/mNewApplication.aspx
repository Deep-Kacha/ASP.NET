<%@ Page Title="" Language="C#" MasterPageFile="~/LoanMaster.Master"
    AutoEventWireup="true" CodeBehind="mNewApplication.aspx.cs"
    Inherits="LoanDemo.mNewApplication" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
    <asp:Label ID="Label1" runat="server" Text="NEW LOAN APPLICATION" Style="font-weight: 700"></asp:Label>
    <br /><br />
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtAccountNo" runat="server"
                    AutoPostBack="True"
                    OnTextChanged="txtsavingaccount_TextChanged"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                    runat="server" ControlToValidate="txtAccountNo"
                    ErrorMessage="Account No is Required" ForeColor="Red" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator7"
                    runat="server" ControlToValidate="ddlLoanCategory"
                    InitialValue="Select" ErrorMessage="Select Loan Category"
                    ForeColor="Red" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator8"
                    runat="server" ControlToValidate="ddlLoanType"
                    InitialValue="Select" ErrorMessage="Select Loan Type"
                    ForeColor="Red" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3"
                    ...
                    ErrorMessage="Issue Date is Required" ForeColor="Red" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RangeValidator ID="RangeValidator1"
                    ...
                    MinimumValue="50000" MaximumValue="2000000"
                    Type="Integer"
                    ErrorMessage="Amount must be between 50000 and 2000000"
                    ForeColor="Red" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4"
                    runat="server" ControlToValidate="txtCurrentAddress"
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5"
                    ...
                    ErrorMessage="Remarks is Required" ForeColor="Red" />
            </td>
        </tr>
    </table>
